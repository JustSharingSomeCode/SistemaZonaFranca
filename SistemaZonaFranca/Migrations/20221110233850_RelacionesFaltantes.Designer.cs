...
namespace SistemaZonaFranca.Migrations
{
    ...
    [Migration("20221110233850_RelacionesFaltantes")]
    partial class RelacionesFaltantes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaZonaFranca.Models.Envio", b =>
                {
                    b.HasOne("SistemaZonaFranca.Models.Ciudad", "CiudadDestino")
                        .WithMany()
                        .HasForeignKey("CiudadDestinoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SistemaZonaFranca.Models.Ciudad", "CiudadOrigen")
                        .WithMany()
                        .HasForeignKey("CiudadOrigenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SistemaZonaFranca.Models.Factura", "Factura")
                        .WithMany()
            ...
            modelBuilder.Entity("SistemaZonaFranca.Models.FacturaDetalle", b =>
                {
                    ...
                    b.HasOne("SistemaZonaFranca.Models.Inventario", "Inventario")
                        .WithMany()
