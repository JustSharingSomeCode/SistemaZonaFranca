...
namespace SistemaZonaFranca.Controllers
{
    public class InventariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,Stock,Precio")] Inventario inventario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descripcion,Stock,Precio")] Inventario inventario)
        {
            if (id != inventario.Id)
            {
                return NotFound();
